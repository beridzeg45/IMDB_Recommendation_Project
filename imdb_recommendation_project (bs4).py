...
def return_movie_info(movie_url):  
    ...
    try:
        poster=soup.select_one('div[class="ipc-poster ipc-poster--baseAlt ipc-poster--dynamic-width ipc-sub-grid-item ipc-sub-grid-item--span-2"] img').get_attribute('src')
    except:
        poster=None
    ...
    try:
        year=soup.select_one('ul[class="ipc-inline-list ipc-inline-list--show-dividers sc-d8941411-2 cdJsTz baseAlt"]').text
    except:
        year=None

    try:
        rating=soup.select_one('div[class="sc-bde20123-0 dLwiNw"]').text
    except:
        rating=None
    ...
    try:
        director=soup.select_one('div[class="sc-b7c53eda-3 vXcqY"]').text
    except:
        director=None

    try:
        genres=soup.select_one('div[data-testid="genres"]').text
    except:
        genres=None
